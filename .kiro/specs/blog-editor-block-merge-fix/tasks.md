...
- [x] 1. Viết test exploration cho bug condition (round-trip mất blocks)
...
- [x] 3. Sửa lỗi gộp khối khi round-trip Visual ↔ HTML
  ...
  - [x] 3.2 Xác nhận bug condition exploration test PASS
  ...
  - [x] 3.3 Xác nhận preservation tests vẫn PASS
    - **Property 2: Preservation** - Hành vi Không thay đổi cho Non-roundtrip Operations
